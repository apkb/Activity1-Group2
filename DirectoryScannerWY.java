    ...
    public void scan() throws IllegalStateException {
        ...
        try {
            synchronized (this) {
                ...
                final boolean nullInclude = (includes == null);
                includes = nullInclude
                    ? new String[] {SelectorUtils.DEEP_TREE_MATCH} : includes;
                final boolean nullExclude = (excludes == null);
                excludes = nullExclude ? new String[0] : excludes;
                ...
                clearCaches();
                includes = nullInclude ? null : includes;
                excludes = nullExclude ? null : excludes;
            }
